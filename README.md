You are supposed to conduct exploratory data analysis (EDA) on the dataset attached in the mail. The candidates are supposed to attach a code file and a report on the inferences that they have drawn. 
